...
public class ServicioTask extends AsyncTask<Void, Void, String> {
    ...
    public ServicioTask(Context ctx, String linkAPI, String cod, String nombre, String apellido, String celular, String usuar, String pass){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            parametrosPost.put("usuar", usuar);
            parametrosPost.put("pass", pass);
